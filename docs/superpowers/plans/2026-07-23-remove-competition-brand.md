...
- Remove every occurrence of「智在家鄉」and every explicit MediaTek competition/submission association.
...
- [ ] **Step 1: Record the failing content assertion**
...
- [ ] **Step 2: Replace competition-oriented copy**
...
- [ ] **Step 3: Verify public identity cleanup**
...
- [ ] **Step 1: Rename the deployable workflow file**
...
- [ ] **Step 2: Replace workflow display strings and update dates**
...
- [ ] **Step 3: Verify zero repository residue**

Run: `rg -n --hidden -g '!.git' "智在家鄉|聯發科技|數位社會創新競賽|為.*競賽.*打造" .`
...
- [ ] **Step 1: Parse every JSON-LD block**
...
- [ ] **Step 2: Parse workflow JSON and sitemap XML**
